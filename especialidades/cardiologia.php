...
function _norm_card(string $s): string {
...
$specId = 0;
$target = _norm_card($specName);
foreach ($app->getSpecialties() as $s) {
  if (_norm_card($s['name']) === $target) { $specId = (int)$s['id']; break; }
}
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-intro" role="tabpanel" aria-labelledby="pills-intro-tab">
                            <div class="card shadow-lg p-4">
                                <h5 class="card-title texto-color fw-bold">El Corazón, Centro de tu Bienestar</h5>
                                <p class="card-text text-muted">
                                    La Cardiología es la especialidad dedicada al diagnóstico y tratamiento de las enfermedades del corazón y del sistema circulatorio.
                                </p>
                                <h5 class="card-title texto-color fw-bold mt-4">¿Cuándo necesitas un  Cardiólogo? </h5>
                                <p class="card-text text-muted">
                                    Es vital consultar ante síntomas como dolor en el pecho, dificultad para respirar, palpitaciones o mareos frecuentes.
                                </p>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="pills-servicios" role="tabpanel" aria-labelledby="pills-servicios-tab">
                            <div class="card shadow-lg p-4">
                                <h5 class="mb-3 texto-color fw-bold">Pruebas Diagnósticas Clave</h5>
                                <p>Utilizamos tecnología avanzada para obtener un diagnóstico preciso y temprano de cualquier condición cardiovascular.</p>
                                <h5 class="mb-3 texto-color fw-bold">Enfermedades y manejo clínico</h5>
                                <p>Nuestros cardiólogos se especializan en el control y tratamiento integral de:</p>
                                <ul class="card-text text-muted">
                                    <li>Hipertensión Arterial: Manejo integral y personalizado.</li>
                                    <li>Insuficiencia Cardíaca: Control y seguimiento a largo plazo.</li>
                                    <li>Rehabilitación Cardíaca: Programas post-infarto o cirugía.</li>
                                </ul>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="pills-medicos" role="tabpanel" aria-labelledby="pills-medicos-tab">
                            <h5 class="mb-4 text-clinic-blue fw-bold">Conoce a Nuestros Cardiólogos Certificados</h5>
                            <?php if (!$specId): ?>
